...
var makeParStruct = ({
  ...
  nu, anti, E, L, th12, th23, th13, Dm21sq, Dm31sq, dCP, rho
});
...
function Matrices(pars) {
  ...
  this.U1 = math.matrix([[1, 0, 0],
                          [0, this.c23, this.s23],
                          [0, -this.s23, this.c23]]);

  this.U2 = math.matrix([[this.c13, 0, math.multiply(this.s13,this.emdcp)],
                          [0, 1, 0],
                          [math.multiply(-this.s13,this.edcp), 0, this.c13]]);
  
  this.U3 = math.matrix([[this.c12, this.s12, 0],
                          [-this.s12, this.c12, 0],
                          [0, 0, 1]]);
...
function oscillate(p, m) {
  ...
  var Hexp = math.multiply(math.complex(0,1), -conv*p.get("L")/p.get("E"), m.H);
